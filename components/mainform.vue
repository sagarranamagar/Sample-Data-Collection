...
<div v-if="alert" id="toast-default" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-blue-500 bg-blue-100 rounded-lg dark:bg-blue-800 dark:text-blue-200">
        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 18 20">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.147 15.085a7.159 7.159 0 0 1-6.189 3.307A6.713 6.713 0 0 1 3.1 15.444c-2.679-4.513.287-8.737.888-9.548A4.373 4.373 0 0 0 5 1.608c1.287.953 6.445 3.218 5.537 10.5 1.5-1.122 2.706-3.01 2.853-6.14 1.433 1.049 3.993 5.395 1.757 9.117Z"/>
        </svg>
        <span class="sr-only">Fire icon</span>
    </div>
    <div class="ms-3 text-sm font-normal">Gif Description Can Not Be Null.</div>
</div>




<div v-if="anscount" id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl">
      ...
      <figure v-if="renderGif < 10" class="mt-10">
        ...
        <figcaption class="mt-10">
          ...
          <div
            class="mt-4 space-x-3 text-base"
          >
            <div class="mb-12">
              <label
                for="large-input."
          ...
          <div class="mt-4 flex justify-center">
            <nuxt-link to="/">
                <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Choose Another Nation</button>
            </nuxt-link>
            <button @click="submitAns" type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Submit</button>
          </div>
        </figcaption>
      </figure>
      <div v-else>
...
const countries = ref([
  ...
  },
  {
    ...
    description:
      "Vui lòng mô tả hành động dưới đây bằng tiếng Thái bản địa",
  },
  {
    id: "3",
    name: "Philippines",
    ...
    description:
      "Pakilarawan ang aksyon sa ibaba sa iyong sariling wika",
  },
  {
    id: "4",
    name: "Indonesia",
  ...
  },
  {
    ...
    description:
      "សូមពណ៌នាសកម្មភាពខាងក្រោមជាភាសាកំណើតរបស់អ្នក។",
  },
  {
    id: "6",
    name: "Laos",
...
console.log("test", nationId.value);

const nation = ref({});

const filteredArray = countries.value.filter((obj) => obj.id == nationId.value);

console.log("nation", filteredArray[0].name);
